...
# Coursework
PhD students are required to complete 26 course credits, including 17 required credits and 9 elective credits. 
...
d1 <- drop_na(d)
kbl(d1, caption = "Example EBOH Electives (check Departmental website)") %>%
