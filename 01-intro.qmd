...
tasks <- data.frame(
  task= c("Epi Methods I (704)", "Study Design (703)", 
    ...
    "Defend thesis"),
  start_m = c(0, 0, 4, 4, 8, 12, 12, 12, 0, 3, 20, 16, 19, 32, 36, 44, 45),
  start_d = c(0, 0, 0, 0, 0, 0, 0, 0, 0, 15, 14, 0, 14, 14, 0, 14, 0),
  end_m   = c(3, 3, 7, 7, 8, 19, 19, 19, 19, 4, 20, 19, 43, 32, 39, 44, 45),
  end_d   = c(14, 14, 14, 14, 7, 14, 14, 1, 14, 28, 28, 14, 14, 28, 14, 28, 14),
